...
export const metadata: Metadata = {
  ...
  description: 'How StackDrift collects, uses, and protects your data. PIPEDA and GDPR compliant privacy policy covering account data, Stripe payments, and third-party services.',
